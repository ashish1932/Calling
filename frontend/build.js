...
// 4. Bundle index.html
const indexHtmlPath = path.join(srcDir, 'pages', 'index.html');
if (fs.existsSync(indexHtmlPath)) {
  console.log("- Compiling index.html layout...");
  let html = fs.readFileSync(indexHtmlPath, 'utf8');
  
  // Remove individual bundled script tags
  html = html.replace(/<script src="js\/(data|ai|profiles|calling|charts|opd-app|app)\.js"(\?v=\d+)?( defer)??><\/script>\s*/gi, '');
