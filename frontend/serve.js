...
function resolveStaticPath(requestPath) {
  ...
  if (requestPath === '/patient.html') {
    return '/pages/patient.html';
  }
  if (requestPath === '/opd-dashboard.html') {
    return '/pages/opd-dashboard.html';
  }
...
const server = http.createServer((req, res) => {
  ...
  fs.readFile(fullPath, (err, data) => {
    ...
    // Inject secure Content-Security-Policy, cache prevention, and OWASP security headers
